...
public class TypeController {
    ...
    public String editInput(@PathVariable Long id, Model model) {
        ...
        System.out.println(typeService.getType(id).getName());
    ...
    @GetMapping("/types/test")    //这个类测试用
    public String editInput() {


        System.out.println(typeService.getTypeByName("感悟").getName());
        System.out.println(typeService.getType((long) 7).getName());
